...
This project explores how large language models behave in a structured reasoning environment.

Two models play chess against each other by proposing moves. A separate chess engine validates those moves and keeps the board state consistent. Over time, this makes it possible to compare how different models approach the same position.

I wanted this to feel less like a toy and more like an experiment in model behavior.
